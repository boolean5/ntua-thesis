...
echo "*********************** benchmark B13 **********************" >> ${OUTPUT_FILE}
BENCH_COMMAND="benchmark --endpoints=${ENDPOINTS} --conns=100 --clients=100 put --key-size=8 --sequential-keys=false --key-space-size=64000 --total=64000 --val-size=4000"
bench3rounds "$BENCH_COMMAND" "$TEST_COMMAND"

echo "*********************** benchmark B14 **********************" >> ${OUTPUT_FILE}
BENCH_COMMAND="benchmark --endpoints=${ENDPOINTS} --conns=100 --clients=100 put --key-size=8 --sequential-keys=false --key-space-size=4000 --total=4000 --val-size=64000"
bench3rounds "$BENCH_COMMAND" "$TEST_COMMAND"

echo "*********************** benchmark B15 **********************" >> ${OUTPUT_FILE}
BENCH_COMMAND="benchmark --endpoints=${ENDPOINTS} --conns=100 --clients=100 put --key-size=8 --sequential-keys=false --key-space-size=500 --total=500 --val-size=512000"
bench3rounds "$BENCH_COMMAND" "$TEST_COMMAND"

echo "*********************** benchmark B16 **********************" >> ${OUTPUT_FILE}
BENCH_COMMAND="benchmark --endpoints=${ENDPOINTS} --conns=100 --clients=100 put --key-size=8 --sequential-keys=false --key-space-size=256 --total=256 --val-size=1000000"
bench3rounds "$BENCH_COMMAND" "$TEST_COMMAND"

echo "*********************** benchmark B17 **********************" >> ${OUTPUT_FILE}
BENCH_COMMAND="benchmark --endpoints=${ENDPOINTS} --conns=1 --clients=1 range a --consistency=l --total=100000"
bench3roundsfilled "$BENCH_COMMAND" "$TEST_COMMAND"

echo "*********************** benchmark B18 **********************" >> ${OUTPUT_FILE}
BENCH_COMMAND="benchmark --endpoints=${ENDPOINTS} --conns=10 --clients=10 range a --consistency=l --total=100000"
bench3roundsfilled "$BENCH_COMMAND" "$TEST_COMMAND"
